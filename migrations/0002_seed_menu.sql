...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('smash', 'Smash', 'Smash', 'Smash', 'Smash', 'Smash', 'Smash', 1, 1)
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('simple', 'Simple', 'Simple', 'Simple', 'Simple', 'Simple', 'Simple', 2, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('chicken', 'Пилешко', 'Chicken', 'Poulet', 'Pollo', 'Pollo', 'Κοτόπουλο', 3, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('veggie', 'Veggie', 'Veggie', 'Veggie', 'Veggie', 'Veggie', 'Veggie', 4, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('fries', 'Fries', 'Fries', 'Frites', 'Patatine', 'Patatas', 'Πατάτες', 5, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('drinks', 'Безалкохолни', 'Soft Drinks', 'Boissons Sans Alcool', 'Bevande Analcoliche', 'Bebidas Sin Alcohol', 'Αναψυκτικά', 6, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
...
INSERT INTO categories (slug, title_bg, title_en, title_fr, title_it, title_es, title_el, sort_order, is_active)
VALUES ('beer', 'Бира', 'Beer', 'Bière', 'Birra', 'Cerveza', 'Μπίρα', 7, 1)
ON CONFLICT(slug) DO UPDATE SET
  title_bg = excluded.title_bg,
  title_en = excluded.title_en,
  title_fr = excluded.title_fr,
